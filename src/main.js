...
const expirationDateDatePattern = {
  mask: "MM{/}YY",
  blocks: {
    YY: {
...
const expirationDateMasked = IMask(expirationDate, expirationDateDatePattern)
...
function updateExpirationDate(date) {
  ...
  expirationDate.innerText = date.length > 0 ? date : "02/32"
}
